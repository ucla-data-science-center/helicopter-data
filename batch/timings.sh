...
echo "" >> timings.txt
echo "Timing for 5k Entries, Pure AWS:" >> timings.txt
...
echo "" >> timings.txt
echo "Timing for 10k Entries, Pure AWS:" >> timings.txt
...
echo "" >> timings.txt
echo "Timing for 50k Entries, Pure AWS:" >> timings.txt
...
echo "" >> timings.txt
echo "Timing for 150k Entries, Pure AWS:" >> timings.txt
